...
- **Quality gate integration** with bito-lint CLI — path-based rules in `.bito-lint.yaml` drive all checks (token counting, readability scoring, completeness validation, grammar)
